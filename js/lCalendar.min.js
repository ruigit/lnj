window.lCalendar = function() {
    ...
    return a.prototype = {
        ...
        bindEvent: function(a) {
            function b(a) {
                t.gearDate = document.createElement("div"), t.gearDate.className = "gearDate", t.gearDate.innerHTML = '<div class="date_ctrl slideInUp"><div class="area-roll-title">配送日期</div><div class="date_roll_mask"><div class="date_roll"><div><div class="gearq date_yy" data-datetype="date_yy"></div><div class="date_grid"><div>年</div></div></div><div><div class="gearq date_mm" data-datetype="date_mm"></div><div class="date_grid"><div>月</div></div></div><div><div class="gearq date_dd" data-datetype="date_dd"></div><div class="date_grid"><div>日</div></div></div></div></div><div class="date_btn_box"><div class="date_btn lcalendar_cancel">取消</div><div class="date_btn lcalendar_finish">确定</div></div></div>', document.body.appendChild(t.gearDate), c();
            ...
            // 年月
            function yb(a) {
                t.gearDate = document.createElement("div"), t.gearDate.className = "gearDate", t.gearDate.innerHTML = '<div class="date_ctrl slideInUp"><div class="area-roll-title">配送日期</div><div class="date_roll_mask"><div class="time_roll"><div><div class="gearq date_yy" data-datetype="date_yy"></div><div class="date_grid"><div>年</div></div></div><div><div class="gearq date_mm" data-datetype="date_mm" style="text-indent: -50%;"></div><div class="date_grid"><div>月</div></div></div></div></div><div class="date_btn_box"><div class="date_btn lcalendar_cancel">取消</div><div class="date_btn lcalendar_finish">确定</div></div></div>', document.body.appendChild(t.gearDate), yc();
                var b = t.gearDate.querySelector(".lcalendar_cancel");
                b.addEventListener("touchstart", p);
                var c = t.gearDate.querySelector(".lcalendar_finish");
                c.addEventListener("touchstart", ys);
                var e = t.gearDate.querySelector(".date_yy"),
                    f = t.gearDate.querySelector(".date_mm");
                e.addEventListener("touchstart", k), f.addEventListener("touchstart", k), e.addEventListener("touchmove", l), f.addEventListener("touchmove", l), e.addEventListener("touchend", m), f.addEventListener("touchend", m)
            }
            ...
            function yc() {
                ...
                /^\d{4}-\d{1,2}-\d{1,2}$/.test(t.trigger.value) ? (rs = t.trigger.value.match(/(^|-)\d{1,4}/g), b.yy = rs[0] - t.minY, b.mm = rs[1].replace(/-/g, "") - 1, b.dd = rs[2].replace(/-/g, "") - 1) : b.yy = b.yy + 1900 - t.minY, t.gearDate.querySelector(".date_yy").setAttribute("val", b.yy), t.gearDate.querySelector(".date_mm").setAttribute("val", b.mm), h()
            }
            // end
            function d(a) {
                t.gearDate = document.createElement("div"), t.gearDate.className = "gearDatetime", t.gearDate.innerHTML = '<div class="date_ctrl slideInUp"><div class="area-roll-title">配送日期</div><div class="date_roll_mask"><div class="datetime_roll"><div><div class="gearq date_yy" data-datetype="date_yy"></div><div class="date_grid"><div>年</div></div></div><div><div class="gearq date_mm" data-datetype="date_mm"></div><div class="date_grid"><div>月</div></div></div><div><div class="gearq date_dd" data-datetype="date_dd"></div><div class="date_grid"><div>日</div></div></div><div><div class="gearq time_hh" data-datetype="time_hh"></div><div class="date_grid"><div>时</div></div></div><div><div class="gearq time_mm" data-datetype="time_mm"></div><div class="date_grid"><div>分</div></div></div></div></div><div class="date_btn_box"><div class="date_btn lcalendar_cancel">取消</div><div class="date_btn lcalendar_finish">确定</div></div></div>', document.body.appendChild(t.gearDate), e();
                var b = t.gearDate.querySelector(".lcalendar_cancel");
                b.addEventListener("touchstart", p);
                var c = t.gearDate.querySelector(".lcalendar_finish");
            ...
            function f(a) {
                t.gearDate = document.createElement("div"), t.gearDate.className = "gearDate", t.gearDate.innerHTML = '<div class="date_ctrl slideInUp"><div class="area-roll-title">配送日期</div><div class="date_roll_mask"><div class="time_roll"><div><div class="gearq time_hh" data-datetype="time_hh"></div><div class="date_grid"><div>时</div></div></div><div><div class="gearq time_mm" data-datetype="time_mm"></div><div class="date_grid"><div>分</div></div></div></div></div><div class="date_btn_box"><div class="date_btn lcalendar_cancel">取消</div><div class="date_btn lcalendar_finish">确定</div></div></div>', document.body.appendChild(t.gearDate), g();
                var b = t.gearDate.querySelector(".lcalendar_cancel");
                b.addEventListener("touchstart", p);
                var c = t.gearDate.querySelector(".lcalendar_finish");
            ...
            function h() {
                ...
                if(b && b.getAttribute("val")) {
                    for(var d = parseInt(b.getAttribute("val")), e = 0; a - 1 >= e; e++) c += "<div class='toothq'>" + (t.minY + e) + "</div>";
                    b.innerHTML = c;
                    ...
                    if(h && h.getAttribute("val")) {
                        ...
                        for(var e = 0; k - l + 1 > e; e++) c += "<div class='toothq'>" + (l + e + 1) + "</div>";
                        ...
                        if(m && m.getAttribute("val")) {
                            ...
                            for(var e = 0; p - q + 1 > e; e++) c += "<div class='toothq'>" + (q + e + 1) + "</div>";
            ...
            function i() {
                ...
                if(a && a.getAttribute("val")) {
                    for(var b = "", c = parseInt(a.getAttribute("val")), d = 0; 23 >= d; d++) b += "<div class='toothq'>" + d + "</div>";
                    ...
                    if(e && e.getAttribute("val")) {
                        for(var b = "", f = parseInt(e.getAttribute("val")), d = 0; 59 >= d; d++) b += "<div class='toothq'>" + d + "</div>";
            ...
            function k(a) {
                a.preventDefault();
                for(var b = a.target;;) {
                    if(b.classList.contains("gearq")) break;
                    b = b.parentElement
                }
            ...
            function ys(a) {
                ...
                d = d > 9 ? d : "0" + d, t.trigger.value = c % b + t.minY + "-" + d, p(a)
            }
            var t = this;
